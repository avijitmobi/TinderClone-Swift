...
//  MeetAfghans
//
//  Created by Convergent Infoware on 06/02/21.
...
extension UIView {
    open func addRippleAnimation(color: UIColor, rippleWidth: CGFloat = 2, duration: Double = 3, repeatCount: Int = 1, rippleCount: Int = 3, rippleDistance: CGFloat? = nil, expandMaxRatio ratio: CGFloat = 1, startReset: Bool = true, handler:((CAAnimation)->Void)? = nil) {
        if startReset {
